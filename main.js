...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "hiddenElement": () => (/* binding */ hiddenElement),
/* harmony export */   "hideActiveDropDown": () => (/* binding */ hideActiveDropDown),
...
const renderPage = (
  ...
  header.replaceChildren((0,_header__WEBPACK_IMPORTED_MODULE_0__.createHeader)());
  nav.replaceChildren((0,_nav__WEBPACK_IMPORTED_MODULE_1__.createNav)(homeLinks, projectLinks, tabID));
  todoList.id = tabID;
  todoList.replaceChildren((0,_todolist__WEBPACK_IMPORTED_MODULE_2__.createTodoList)(project, tabName, homeLinks));
};
...
const createHeader = () => {
  ...
  fragment.appendChild(
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('menu', 'material-icons-round menu-icon', 'span')
  );
...
const createLogoSection = () => {
  const logoSection = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'logo-section', 'div');
  const title = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Todo', 'header-title', 'div');

  title.appendChild((0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('List', 'header-title-text', 'span'));
...
/* harmony export */   "createOptionsMenu": () => (/* binding */ createOptionsMenu)
/* harmony export */ });
const createDomElement = (text, className, tag) => {
...
const createOptionsMenu = (text, type) => {
...
/* harmony export */ });
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helper */ "./src/modules/helper.js");
/* harmony import */ var _images_all_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../images/all.png */ "./src/images/all.png");
...
/* harmony import */ var _images_7day_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../images/7day.png */ "./src/images/7day.png");
/* harmony import */ var _images_star_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../images/star.png */ "./src/images/star.png");
...
const imgs = [_images_all_png__WEBPACK_IMPORTED_MODULE_1__, _images_today_png__WEBPACK_IMPORTED_MODULE_2__, _images_7day_png__WEBPACK_IMPORTED_MODULE_3__, _images_star_png__WEBPACK_IMPORTED_MODULE_4__];

const createNav = (homeLinks, projectLinks, tabID) => {
  let fragment = document.createDocumentFragment();
...
const homeSection = (homeLinks, tabID) => {
  const home = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'home-section', 'div');
  const title = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Home', 'home-title', 'h2');
...
const createHomeLinks = (homeLinks, tabID) => {
  const links = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'home-links', 'div');
...
const createHomeLink = (homeLink, src, tabID) => {
  const link = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'home-link', 'div');
  const linkText = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(homeLink, 'home-link-text', 'div');
...
const projectSection = (projectLinks, tabID) => {
  const project = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'project-section', 'div');
  const title = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Projects', 'project-title', 'h2');
...
const createProjectLinks = (projectLinks, tabID) => {
  const links = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'project-links', 'div');
  const addProject = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'add-project', 'div');
  ...
  addProject.appendChild(
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('add', 'material-icons-round add', 'span')
  );
  addProject.appendChild(
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Add Project', 'add-btn-text', 'div')
  );
...
const createProjectLink = (projectLink, tabID) => {
  const link = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'project-link', 'div');
  const linkText = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(
    projectLink.title,
    'project-link-text',
    'div'
  );
  ...
  link.appendChild(
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('menu', 'material-icons-round nav-icon', 'span')
  );
  link.appendChild(linkText);
  link.appendChild(
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('more_vert', 'material-icons-round more-icon', 'span')
  );
  link.appendChild((0,_helper__WEBPACK_IMPORTED_MODULE_0__.createOptionsMenu)('Rename', 'project'));
...
const projectForm = (type, value) => {
  const form = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(
    '',
    `${type.toLowerCase()}-project-form`,
    'form'
  );
  const inputs = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'form-inputs', 'div');
  const projectName = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'project-name-input', 'input');
  const formBtns = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'form-btns-input', 'div');
  const addRenameBtn = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(type, 'form-btn', 'button');
  const cancelBtn = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Cancel', 'form-btn', 'button');
...
/* harmony import */ var _displaycontroller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./displaycontroller */ "./src/modules/displaycontroller.js");
/* harmony import */ var _nav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./nav */ "./src/modules/nav.js");
...
header.addEventListener('click', (e) => {
  ...
  if (target.classList.contains('menu-icon')) {
    (0,_displaycontroller__WEBPACK_IMPORTED_MODULE_2__.hiddenElement)(target.parentElement.nextElementSibling);
...
nav.addEventListener('click', (e) => {
  ...
  if (target.classList.contains('add-project')) {
    let currentTab = (0,_displaycontroller__WEBPACK_IMPORTED_MODULE_2__.getCurrentTab)();
    renderHomeLink(currentTab.children[1].textContent, currentTab.id);
    let form = path[3].querySelector('.add-project-form');

    if (form.classList.contains('hidden')) {
      (0,_displaycontroller__WEBPACK_IMPORTED_MODULE_2__.hiddenElement)(form);
    }
  }
  ...
  if (target.id === 'project-rename') {
    ...
    const form = (0,_nav__WEBPACK_IMPORTED_MODULE_3__.projectForm)('Rename', text);
  ...
  if (target.id === 'cancel-project-btn') {
    (0,_displaycontroller__WEBPACK_IMPORTED_MODULE_2__.hiddenElement)(target.form);
...
todoList.addEventListener('click', (e) => {
  ...
  if (target.id === 'task-edit') {
    ...
    const form = (0,_todolist__WEBPACK_IMPORTED_MODULE_4__.taskForm)('Edit', formValues);
...
content.addEventListener('click', (e) => {
  ...
  if (target.classList.contains('more-icon')) {
    if (target.nextSibling.classList.contains('hidden')) {
      (0,_displaycontroller__WEBPACK_IMPORTED_MODULE_2__.hideActiveDropDown)();
    }
    (0,_displaycontroller__WEBPACK_IMPORTED_MODULE_2__.hiddenElement)(target.nextSibling);
  }
...
content.addEventListener('submit', (e) => {
  ...
  if (target.classList.contains('edit-task-form')) {
    ...
    projects[indices[0]].tasks[indices[1]].dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(target[2].value);
...
const renderHomeLink = (text, id) => {
  (0,_displaycontroller__WEBPACK_IMPORTED_MODULE_2__.renderPage)(sortTasks(id), text, id, homeLinks, projects);
};
...
const createProject = (title, projectID) => {
  ...
  const newProject = (0,_project__WEBPACK_IMPORTED_MODULE_1__["default"])(id, title);
...
const todayTasks = (projects) => {
  ...
  for (let i = 0; i < projects.length; i++) {
    const project = projects[i].tasks;
    for (let j = 0; j < project.length; j++) {
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(project[j].dueDate)) {
...
const nextSevenDayTasks = (projects) => {
  ...
  const sevenDays = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(today, 7);
  const nextSevenDayTasks = [];

  for (let i = 0; i < projects.length; i++) {
    const project = projects[i].tasks;
    for (let j = 0; j < project.length; j++) {
      const sevenDayInterval = (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(project[j].dueDate, {
        start: today,
        end: sevenDays,
      });
      if (sevenDayInterval) {
...
const init = () => {
  checkStorage();
  (0,_displaycontroller__WEBPACK_IMPORTED_MODULE_2__.renderPage)(
    allTasks(projects),
    homeLinks[0],
    homeLinks[0].toLowerCase().replace(/\s/g, '-'),
    homeLinks,
...
const Task = (id, title, description, dueDate, complete, important) => {
  dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(dueDate);
...
const createTodoList = (project, tabName, homeLinks) => {
  ...
  if (!homeLinks.includes(tabName)) {
    const addTask = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'add-task', 'div');
    addTask.appendChild(
      (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('add', 'material-icons-round add', 'span')
    );
    addTask.appendChild((0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Add Task', 'add-btn-text', 'div'));
...
const createTodoHeader = (tabName) => {
  const header = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(tabName, 'todo-list-title', 'div');

  return header;
};

const createTodoListItems = (project) => {
  const todoListItems = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'todo-list-items', 'ul');
...
const createItem = (projectItem) => {
  let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(projectItem.dueDate, 'MM/dd/yyyy');
  const item = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'item', 'li');
  item.id = projectItem.id;
  const column = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'details-column', 'div');
  const checkMark = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'item-check', 'div');
  const star = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('star', 'material-icons-round star', 'span');
  ...
  column.appendChild((0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(projectItem.title, 'item-title', 'div'));
  column.appendChild(
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(projectItem.description, 'item-description', 'div')
  );

  item.appendChild(checkMark);
  item.appendChild(column);
  item.appendChild((0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(formattedDate, 'item-date', 'div'));
  item.appendChild(star);

  item.appendChild(
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('more_vert', 'material-icons-round more-icon', 'span')
  );
  item.appendChild((0,_helper__WEBPACK_IMPORTED_MODULE_0__.createOptionsMenu)('Edit', 'task'));

  return item;
};

const taskForm = (type, values) => {
  const form = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', `${type.toLowerCase()}-task-form`, 'form');
  const inputs = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'form-inputs', 'div');
  const taskTitle = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'task-input', 'input');
  const taskDescription = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'task-input', 'textarea');
  const taskDueDate = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'task-input', 'input');
  const formBtns = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('', 'form-btns-input', 'div');
  const addEditBtn = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(type, 'form-btn', 'button');
  const cancelBtn = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Cancel', 'form-btn', 'button');
  ...
  if (values.length > 0) {
    ...
    taskDueDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(values[2], 'MM/dd/yyyy', new Date()), {
      representation: 'date',
    });
  }
  ...
  formBtns.appendChild(cancelBtn);
  inputs.appendChild((0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Title:', 'input-label', 'label'));
  inputs.appendChild(taskTitle);
  inputs.appendChild((0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Description:', 'input-label', 'label'));
  inputs.appendChild(taskDescription);
  inputs.appendChild((0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)('Due Date:', 'input-label', 'label'));
...
module.exports = __webpack_require__.p + "73ea19b11b2e25ae05bf.png";
...
module.exports = __webpack_require__.p + "edd140d9212593a2fd2e.png";
...
module.exports = __webpack_require__.p + "d5ae05847cecb81d2720.png";
...
module.exports = __webpack_require__.p + "12dba3e18cdc78e94aab.png";
...
module.exports = __webpack_require__.p + "67938218ed2aff843c63.png";
