...
const renderPage = (project, tab) => {
  content.appendChild((0,_header__WEBPACK_IMPORTED_MODULE_0__.createHeader)());
  content.appendChild((0,_todolist__WEBPACK_IMPORTED_MODULE_1__.createTodoList)(project, tab));
};
...
const createDefaultProject = () => {
  ...
  const task1 = (0,_task__WEBPACK_IMPORTED_MODULE_0__["default"])('Elden Ring', 'PC', '2022-02-28', 'High', true, true);
  ...
  const task4 = (0,_task__WEBPACK_IMPORTED_MODULE_0__["default"])('The Batman', 'Hbo', '2022-03-04', 'High', false, false);
  const task5 = (0,_task__WEBPACK_IMPORTED_MODULE_0__["default"])('The Flash', 'Vudu', '2022-05-11', 'Low', false, false);
  const task6 = (0,_task__WEBPACK_IMPORTED_MODULE_0__["default"])('Alien', 'Netflix', '2022-02-28', 'Medium', false, false);
...
const init = () => {
  ...
  (0,_displaycontroller__WEBPACK_IMPORTED_MODULE_2__.renderPage)(createAllTasksArray(projects), 'All Tasks');
};
...
const Task = (title, description, dueDate, priority, complete, important) => {
  dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate), 'MM/dd/yyyy');
...
const createTodoList = (project, tab) => {
...
const createTodoHeader = (tab) => {
  const header = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.createDomElement)(tab, 'todo-list-title', 'div');
